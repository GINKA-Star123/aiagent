...
维护说明（2026-07-07）：本文档是历史自动盘点快照，部分条目可能已与当前工作区不一致，例如 `apps/web` 和 `domain/*`。当前人工维护的结构说明以 `README.md`、`docs/config-reference.md` 和 `docs/project-overview-next-stage.md` 为准；需要精确盘点时应重新运行生成脚本。
